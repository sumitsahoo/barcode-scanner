...
const IconRotateCamera = ({ className = "", ...props }) => (
    ...
    >
        ...
        <g id="SVGRepo_iconCarrier">
            ...
            <path d="M16.13 5.32L13.24 2" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"
                strokeLinejoin="round" />
            <path d="M16.13 5.32007L12.76 7.78007" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"
                strokeLinejoin="round" />
        </g>
    </svg>
);
