...
const IconRotateCamera = ({ className = "", ...props }) => (
    ...
    >
        ...
        <g id="SVGRepo_iconCarrier">
            ...
            <path d="M16.13 5.32L13.24 2" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                stroke-linejoin="round"></path>
            <path d="M16.13 5.32007L12.76 7.78007" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                stroke-linejoin="round"></path>
        </g>
    </svg>
);
