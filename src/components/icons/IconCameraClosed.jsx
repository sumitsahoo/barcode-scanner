/**
 * SVG icon component for a closed camera. The stroke color is set to currentColor,
...
const IconCameraClosed = ({ className = "", ...props }) => (
  <svg
    viewBox="0 0 24 24"
    fill="none"
    className={className}
    ...
    {...props}
  >
    <title>Camera Closed Icon</title>
    <path
...
export default memo(IconCameraClosed);
